  ...
  <footer id="footer" className="py-16 bg-white border-t border-border/60 text-[hsl(220,60%,20%)]">
    <div className="container mx-auto px-4 sm:px-6">
      ...
      >
        ...
        <motion.div variants={staggerItem}>
          ...
          <div className="flex items-center gap-3 mt-5" role="list" aria-label="Réseaux sociaux">
            ...
            <motion.a
              ...
              className="h-9 w-9 rounded-full bg-[hsl(220,60%,20%)]/8 flex items-center justify-center text-[hsl(220,60%,20%)]/70 hover:bg-[hsl(320,70%,45%)] hover:text-white transition-colors duration-200"
            >
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.92 }}
              transition={{ type: "spring", stiffness: 400, damping: 17 }}
              className="h-9 w-9 rounded-full bg-[hsl(220,60%,20%)]/8 flex items-center justify-center text-[hsl(220,60%,20%)]/70 hover:bg-[hsl(210,90%,40%)] hover:text-white transition-colors duration-200"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4" aria-hidden="true">
            ...
            <motion.a
              ...
              whileTap={{ scale: 0.92 }}
              transition={{ type: "spring", stiffness: 400, damping: 17 }}
              className="h-9 w-9 rounded-full bg-[hsl(220,60%,20%)]/8 flex items-center justify-center text-[hsl(220,60%,20%)]/70 hover:bg-[hsl(220,80%,45%)] hover:text-white transition-colors duration-200"
            >
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="h-4 w-4" aria-hidden="true">
        ...
        {/* Quick links */}
        <motion.div variants={staggerItem}>
          <h3 className="font-semibold text-sm uppercase tracking-wider text-[hsl(220,60%,20%)]/70 mb-5">
            Liens rapides
          </h3>
        ...
        {/* Contact */}
        <motion.div variants={staggerItem}>
          <h4 className="font-semibold text-sm uppercase tracking-wider text-[hsl(220,60%,20%)]/70 mb-5">
            Contact
          </h4>
      ...
      {/* Bottom bar */}
      <div className="mt-10 pt-6 border-t border-[hsl(220,60%,20%)]/20 text-center text-sm text-[hsl(220,60%,20%)]/70">
        <p>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="font-semibold text-[hsl(220,60%,20%)]/70 transition-colors"
          >
            MONARK IT
          </a>
