...
const Footer = () => (
  <footer id="footer" className="py-12 bg-white text-[hsl(220,60%,20%)]">
    <div className="container mx-auto px-4">
          ...
          <ul className="space-y-2 text-sm text-[hsl(220,60%,20%)]/70">
            {[
              ...
              <li key={link.href}>
                <a
                  href={link.href}
                  className="hover:text-[hsl(220,60%,20%)] transition-colors duration-200 hover:translate-x-1 inline-block"
                >
                  {link.label}
                </a>
              </li>
          ...
          <ul className="space-y-3 text-sm text-[hsl(220,60%,20%)]/70">
            <li className="flex items-start gap-2">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="hover:text-[hsl(220,60%,20%)] transition-colors duration-200"
            ...
            <li className="flex items-center gap-2">
              ...
              <a
                ...
                className="hover:text-[hsl(220,60%,20%)] transition-colors duration-200 break-all"
      ...
      <motion.div
        ...
        whileInView="visible"
        viewport={viewport}
        className="mt-10 pt-6 border-t border-[hsl(220,60%,20%)]/20 text-center text-sm text-[hsl(220,60%,20%)]/50"
      >
        <p>
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="font-semibold text-[hsl(220,60%,20%)]/50 hover:text-[hsl(220,60%,20%)] transition-colors duration-200"
          >
            MONARK IT
          </a>
