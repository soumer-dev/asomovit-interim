  ...
  <footer id="footer" className="py-16 bg-white border-t border-border/60 text-[hsl(220,60%,20%)]">
    <div className="container mx-auto px-4 sm:px-6">
      ...
      <motion.div
        ...
        whileInView="visible"
        viewport={viewport}
        className="mt-12 pt-6 border-t border-[hsl(220,60%,20%)]/10 flex flex-col sm:flex-row items-center justify-between gap-3 text-xs text-[hsl(220,60%,20%)]/40"
      >
        <p>
          © {new Date().getFullYear()} ASOMOVIT MULTISERVICES. Tous droits réservés.
        </p>
        <p>
          Réalisé par{" "}
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="font-semibold hover:text-[hsl(220,60%,20%)]/70 transition-colors duration-200"
          >
            MONARK IT
          </a>
        </p>
